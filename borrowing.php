		...
		<div class="col-lg-9 well" style="margin-top:60px;">
			...
			<form method="POST" action="borrow.php" enctype="multipart/form-data">
				<div class="form-group pull-left">	
					...
					<select name="student_no" id="student" required>
				...
				<div class="form-group pull-right">	
					<button name="save_borrow" class="btn btn-primary">
						...
						<tr>
							<td>
								...
								<?php else: ?>
									...
									<center><input type="checkbox" class="book-checkbox" name="selector[]" value="1"></center>
								<?php endif; ?>
							</td>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".book-checkbox").on('change', function() {
			let checkedCount = $(".book-checkbox:checked").length;
			if (checkedCount > 4) {
				alert("You can only borrow a maximum of 4 books.");
