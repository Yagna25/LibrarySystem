	...
	<body style = "background-color:#d3d3d3;">
					...
					<table id = "table" class = "table table-bordered">
						...
						<tbody>
							...
							<tr class = "target">
								...
								<td>
									<a href = "#" class = "btn btn-danger deladmin_id" value = "<?php echo $f_admin['admin_id']?>"><span class = "glyphicon glyphicon-remove"></span> Delete</a> 
									<a href = "#" class = "btn btn-warning eadmin_id" value = "<?php echo $f_admin['admin_id']?>"><span class = "glyphicon glyphicon-edit"></span> Edit</a>
								</td>
							</tr>
							<?php } ?>	
						</tbody>
		...
		<script>
			$(document).ready(function(){
				...
				$('.deladmin_id').click(function(e){
					e.preventDefault();
					const adminId = $(this).attr('value');
					actionType = 'delete';
					actionUrl = 'delete_admin.php?admin_id=' + adminId;
					$('#confirmText').text("Are you sure you want to delete this admin?");
					$('#confirmModal').modal('show');
				});

				$('.eadmin_id').click(function(e){
					e.preventDefault();
					const adminId = $(this).attr('value');
					actionType = 'edit';
					actionUrl = 'load_admin.php?admin_id=' + adminId;
					$('#confirmText').text("Are you sure you want to edit this admin?");
					$('#confirmModal').modal('show');
				});
